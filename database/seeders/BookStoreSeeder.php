...
class BookStoreSeeder extends Seeder
{
    public function eerun()
    {
        ...
        PlatformSettings::create([
            'platform_name' => 'Kotobi',
            'contact_email' => 'contact@kotobi.com',
            'contact_phone' => '+213 556 35 50 64',
            'address' => 'Rue Oued Terfa',
            'city' => 'Algiers, Algeria',
            'rc_number' => '16/00-1234567B18',
            'nif_number' => '16123456789',
